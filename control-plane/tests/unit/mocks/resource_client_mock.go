...
// Source: pkg/resource_selector/resource_client.go
//
// Generated by this command:
//
//	mockgen -source=pkg/resource_selector/resource_client.go -destination=tests/unit/mocks/resource_client_mock.go -package mocks
//
...
func (m *MockResourceClient) GetApiV1Resource(url string, selector *resourceselector.Selector) ([]*resourceselector.Resource, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetApiV1Resource", url, selector)
	ret0, _ := ret[0].([]*resourceselector.Resource)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
