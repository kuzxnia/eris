...
// Source: pkg/resource/resource_client.go
//
// Generated by this command:
//
//	mockgen -source=pkg/resource/resource_client.go -destination=tests/unit/mocks/resource_client_mock.go -package mocks
//
...
func (m *MockResourceClient) GetApiV1Resource(url string, selector *resource.Selector) ([]*resource.Resource, error) {
	m.ctrl.T.Helper()
